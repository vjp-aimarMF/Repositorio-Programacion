...
public class Ejercicio25 {
    ...
    public static void main(String[] args) {
        ...
        try { //Control de excepciones
            do {
                ...
                switch (opcion) {
                    case 1:
                        procesador1 = "Intel Core i7";
                        break;
                    case 2:
                        procesador1 = "Intel Core i9";
                        break;
                    case 3:
                        procesador1 = "AMD Ryzen 9 9900X";
                        break;
                    case 4:
                        procesador1 = "AMD Ryzen 9 7950X";
                        break;
                    default:
                ...
                Ordenador pc1 = new Ordenador(ram1, disco1, procesador1, grafica1, precio1);
            ...
            do {
                ...
                System.out.println("Modelo del procesador : ");
                opcion = opcionesProcesador(); //Llamamos al metodo
                switch (opcion) { //Menu de opciones para el procesador
                    case 1:
                        procesador2 = "Intel Core i7";
                        break;
                    case 2:
                        procesador2 = "Intel Core i9";
                        break;
                    case 3:
                        procesador2 = "AMD Ryzen 9 9900X";
                        break;
                    case 4:
                        procesador2 = "AMD Ryzen 9 7950X";
                        break;
                    default:
                        System.out.println("Introduce un valor entre 1 y 4");
                        procesador1 = "";
                ...
                Ordenador pc2 = new Ordenador(ram2, disco2, procesador2, grafica2, precio2); //Objeto con constructor parametrizado

                System.out.println(pc2.toString()); //Imprimo
            ...
            entrada.next();
            System.out.println("Tamaño de la pantalla");
            port2.setTamañoPantalla(entrada.nextInt());
            System.out.println("El peso es : ");
    ...
    public static int opcionesProcesador() { //Metodo para mostrar las opciones
        ...
        System.out.println("2.Intel Core i9");
        System.out.println("3.AMD Ryzen 9 9900X");
        System.out.println("4.AMD Ryzen 9 7950X");
